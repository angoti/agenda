...
public class CriaBancoDeDados {
	...
	public static void main(String[] args) {
		...
		CriaBancoDeDados.criaBase("jdbc:mysql://localhost:3306/contatos?useTimezone=true&serverTimezone=UTC", "root", "");
		CriaBancoDeDados.criaTabela("jdbc:mysql://localhost:3306/contatos?useTimezone=true&serverTimezone=UTC", "root", "");
	}
}
